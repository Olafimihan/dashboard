...
var addOptions = (id, name, options)=>{
    ...
    // //get the available options for the selected question
    ...
    //     resultStr += '<li style="background-color: grey; color: black>'+ options[xx].response_text +'</li>'
